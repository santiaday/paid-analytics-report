#!/usr/bin/env python3
"""
Microsoft Ads WEEKLY report builder.
...
so the bing cohort demos line up with the same Mon–Sun weeks the Brain UI shows.
...
def build_cfg(week_end):
    ...
    return {
        ...
        "headline": f"Microsoft Ads Weekly Report for {period_phrase}",
