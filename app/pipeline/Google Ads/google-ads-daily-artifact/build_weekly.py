#!/usr/bin/env python3
"""
Google Ads WEEKLY report builder.

Computes the Sunday–Saturday week windows + the 12-week chart buckets, then hands
...
def last_completed_sunday(today):
    """Most recent Sunday strictly before today (the end of the last complete Mon–Sun week)."""
...
def build_cfg(week_end):
    ...
    return {
        ...
        "headline": f"Google Ads Weekly Report for {period_phrase}",
