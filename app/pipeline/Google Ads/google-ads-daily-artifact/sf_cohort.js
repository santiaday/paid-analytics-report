...
const CHANNEL = 'google-ads';   // Lead.UTM_Source__c filter (Microsoft copy: 'bing')
const SOURCE  = 'google-ads';   // SOURCE value cohort_demos.py filters on (Microsoft copy: 'bing')
